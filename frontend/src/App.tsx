import TwitterMenu from './TwitterMenu/TwitterMenu';
...
const App = () => {
  ...
  return (
    <>
      <div
        className="compose-tweet-container"
        style={{ display: toggleComposeTweet === true ? 'flex' : 'none' }}
      >
        ...
        <main>
          <div className="twitter-profile-main">
            ...
            <div className="twitter-profile-main-description">
              ⚛️ Software Developer | 🌅 Technical Writer | 🎨 Content Creator |
                  ...
                  <div className="twitter-profile-main-tweets-content">
                    ...
                    <div className="twitter-profile-main-tweets-post">
                      ...
                      {tweet.img === '' ? (
                        ...
                        <img src={tweet.img} alt="Tweet Media" />
                      )}
                    </div>
