...
export const TwitterMenu = ({
  ...
  const { handleToggleComposeTweet } = useTwitter();
  return (
    <>
      <aside>
        ...
        <nav>
          ...
          <a href="/">
            <div>
              ...
              <p data-testid="explore">{explore}</p>
            </div>
          </a>
          <a href="/">
            <div>
          ...
          <a href="/">
            <div>
              ...
              <p data-testid="messages">{messages}</p>
            </div>
          </a>
          <a href="/">
            <div>
              ...
              <p data-testid="bookmarks">{bookmarks}</p>
            </div>
          </a>
          <a href="/">
            <div>
          ...
          <a href="/">
            <div>
              ...
              <p data-testid="more">{more}</p>
            </div>
          </a>
        </nav>
        <div className="tweet-button">
          <button
            onClick={handleToggleComposeTweet}
            className="compose-tweet-btn"
          >
            Tweet
          </button>
        </div>
        <div className="twitter-profile-accounts">
          <div className="profile-picture"></div>
          <div className="twitter-profile-accounts-user">
            <h1>Levi Ackerman</h1>
            <p>@leviackerman</p>
          </div>
          <div className="twitter-profile-accounts-menu">...</div>
        </div>
      </aside>
    </>
  );
